...
namespace VRCCCMod.CC.GameSpecific {
    class UpdateChecker {
        ...
        public static string Check() {
            const string tags_url = "https://api.github.com/repos/gt0777/VRCCCMod/tags";
            ...
            try {
                ...
                getTags.UserAgent = "VRCCCMod Update checker";
                ...
                if(latest > version) {
                    return "Your version (" + version_s + ") is out of date! The latest is " + latest.ToString() + ". Please visit https://github.com/gt0777/VRCCCMod";
                }
